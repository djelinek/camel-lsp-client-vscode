...
describe('Language Support for Apache Camel extension', function () {
	...
	/**
	 * Skipped until reported issue is not present in next vscode-extension-tester release.
	 * Please see https://github.com/redhat-developer/vscode-extension-tester/issues/15
	 */
	describe.skip('Extensions view', function () {
